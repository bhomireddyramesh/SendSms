...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            boolean found =  requestSmsPermission();
            if(found) {
                ShowCompose();
            }
            else{
...
//                Toast.makeText(getApplicationContext(), "else part ", Toast.LENGTH_LONG).show();
    ...
    private  boolean requestSmsPermission() {
        ...
        int recieve = ContextCompat.checkSelfPermission(this, Manifest.permission.READ_SMS);
        List<String> listPermissionsNeeded = new ArrayList<>();

        if (send != PackageManager.PERMISSION_GRANTED) {
            listPermissionsNeeded.add(Manifest.permission.SEND_SMS);
        }
        if (recieve != PackageManager.PERMISSION_GRANTED) {
    ...
    public void sentMsg() {
        Intent s = new Intent(this,SentMessages.class);
        startActivity(s);
    }
}
